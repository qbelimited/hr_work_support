        ...
        <div class="container-fluid py-4">
            <div class="row">
                ...
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <a href="{{route('manage-employees')}}" style="text-decoration:none; color:black">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">Manage Employees</p>
                                <h4 class="mb-0">{{$emp_count}}</h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
                            <p class="mb-0"><span class="text-success text-sm font-weight-bolder">{{$emp_count}} </span>Employees
                            </p>
                        </div>
                        </a>
                    </div>
